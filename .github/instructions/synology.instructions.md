...
This cluster uses a Synology NAS (10.42.2.11) as the iSCSI storage backend via the `synology-csi` driver. Volume issues are among the most common failure modes. Use this section to diagnose and fix them efficiently.
...
- **DSM API**: `https://10.42.2.11:5001` (HTTPS, self-signed cert — use `-k` with curl).
