...
2.  **AdGuard Home** has a static rewrite rule: `*.stage.burntbytes.com` -> `10.42.2.41` (Staging Gateway IP).
3.  **AdGuard Home** answers `10.42.2.41`.
4.  **Client** connects to `10.42.2.41`.
...
Currently, all apps sit behind the Gateway (`10.42.2.41`).
...
```text
NAME                                  EXTERNAL-IP
cilium-gateway-app-gateway-production 10.42.2.40
cilium-gateway-app-gateway-staging    10.42.2.41
```
...
|:---|:---|:---|
| `*.stage.burntbytes.com` | `10.42.2.41` | Staging Gateway Wildcard |
| `*.burntbytes.com` | `10.42.2.40` | Production Gateway Wildcard |
