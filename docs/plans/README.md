...
| :--- | :--- | :--- |
| [2026-05-07-hestia-p2p-enablement.md](2026-05-07-hestia-p2p-enablement.md) | `planned` | Sub-plan: enable GPU P2P on hestia (slot move + BIOS pass + tinygrad driver patch) |
