...
All Flux entry points live under `clusters/melodic-muse/` (single physical cluster):
...
- `infra/configs/`: networking/storage config (Cilium, Gateway API, cert-manager issuers, etc.)
