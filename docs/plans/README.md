...
| :--- | :--- | :--- |
| [2026-09-04-hestia-silent-hang-diagnosis.md](2026-09-04-hestia-silent-hang-diagnosis.md) | 2026-09-04 | hestia froze four times in ~29 hours after 57 days of uptime, leaving no logs at all because the kernel was configured to hang silently; the detectors are now armed, one suspect is stopped as a live experiment, and the remaining work is to make the next hang produce evidence rather than silence |
