...
LEDX = [4.5, 11.5, 18.5]
# LEDs rotated 180 so the cathode sits above R's LED_K pad (straight cathode traces);
# origin is pin 1, so offset +1.27 (half the 2.54mm pin gap) keeps the body centered on LEDX
