...
| File | Last modified | Summary |
| :--- | :--- | :--- |
| [2026-09-04-hestia-crash-diagnosis.md](2026-09-04-hestia-crash-diagnosis.md) | 2026-09-04 | Diagnose why hestia's OS dies while its BMC stays up — two crashes on 2026-09-04, each taking all cluster storage read-only. Fixes the observability gap that makes the crashes self-concealing. |
...
| [2026-07-20-cd-rip-music-library-pipeline.md](2026-07-20-cd-rip-music-library-pipeline.md) | 2026-08-29 | Repeatable CD-rip pipeline: rip (XLD on macOS / EAC on Windows) -> verify -> tag -> organize -> rsync-over-SSH to hestia dataset -> Navidrome scan |
